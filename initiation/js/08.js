...
for (var i = 1; i <= 10; i += 2) {
  // on affecte un variable "i" avec une valeur "1" ; on donne un condition a i "i <= 10" ; une addition "i += 2(i=i+2)"
  console.log("<p>" + "<p>Instruction exécutée : " + i + "</p>"); // si i <= 10 alors il écrit "..." + i + ...
}
...
var j = 1;
while (j <= 10) {
  console.log("<p>" + "<hr /><p>Instruction exécutée : " + j + "</p>");
  /* 50 lignes de code */
  j++; // j = j + 1; OU j += 1;
}
